...
<?php
    header("refresh:3;url=kelola_supplier.php"); // refresh halaman data user
}
?>
...
<?php
    header("refresh:3;url=kelola_supplier.php");
}
...
if (isset($_POST['addkategori'])) {
    ...
    if ($tambahkategori) {
		...
		<meta http-equiv='refresh' content='3; url=kelola_supplier.php'/>  ";
    } else {
        echo "
        <div class='alert alert-danger' role='alert' style='text-align:center ;'>
...
if (isset($_POST['editsup'])) {
    ...
    $editsup = mysqli_query($conn, "Update supplier SET NAMA_SUPPLIER='$namaedit', NOMOR_TELP='$contactedit', ALAMAT='$alamatedit' WHERE ID_SUPPLIER='$idedit'");
    if ($editsup) {
        echo " 
        <div class='alert alert-success' role='alert' style='text-align:center ;'>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="kelola_supplier.php">Supplier</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="" class="btn btn-success btn-md" data-toggle="modal" data-target="#modal<?php echo $p['ID_SUPPLIER'] ?>">Edit</a>

                                                    <!-- modal input -->
                                                    <div id="modal<?php echo $p['ID_SUPPLIER'] ?>" class="modal fade">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                    <input type="hidden" name="idedit" value="<?php echo $p['ID_SUPPLIER']?>">
                                                                        <div class="form-group">
                                                                            <label>Nama Supplier</label>
                                                                            <input name="namaedit" type="text" class="form-control" value="<?php echo $p['NAMA_SUPPLIER']?>" required autofocus>
                                                                            </div>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input name="contactedit" type="text" class="form-control" value="<?php echo $p['NOMOR_TELP']?>" required autofocus>
                                                                        </div>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                        <div class="form-group">
                                                                            <label>Alamat</label>
                                                                            <input name="alamatedit" type="text" class="form-control" value="<?php echo $p['ALAMAT']?>" required autofocus>
                                                                        </div>

                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                                                    <input name="editsup" type="submit" class="btn btn-primary" value="Simpan Perubahan">
                                                                </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        <a href="kelola_supplier.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus Supplier ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
