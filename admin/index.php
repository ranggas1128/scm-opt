...
$countbarang = mysqli_query($conn, "select count(ID_BAHAN) as totalBarang from bahan_stand");
$countbarang2 = mysqli_fetch_assoc($countbarang);
$countbarang3 = $countbarang2['totalBarang'];

$counthabis = mysqli_query($conn, "select count(JUMLAH_BAHAN) as totalBarang from bahan_stand where JUMLAH_BAHAN <= '0'");
$counthabis2 = mysqli_fetch_assoc($counthabis);
$counthabis3 = $counthabis2['totalBarang'];

$countUser = mysqli_query($conn, "select count(ID_USER) as totalUser from user");
$countUser2 = mysqli_fetch_assoc($countUser);
$countUser3 = $countUser2['totalUser'];

$countStand = mysqli_query($conn, "select count(ID_STAND) as totalStand from stand where STATUS like 'Verified'");
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="kategori.php">Suplier</a></li>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Barang Produk</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <!-- $_SESSION['NAMA_ADMIN'] -->
                                    <br>
                                    <p>Pada halaman admin, Anda dapat menambah supplier dan stok produk, mengelola data supplier,
                                        serta mengelola produk</p>
                                </div>
                            </div>
                        </div>
                    </div>
