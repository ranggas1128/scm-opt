...
if ($op == 'delete') {
    $id         = $_GET['id'];
    $sqldelete  = "delete from bahan_stand where id_bahan = '$id'";
...
if (isset($_POST['addbahan'])) {
    ...
    $tambahbahan = mysqli_query($conn, "insert into BAHAN_STAND (ID_BAHAN, NAMA_BAHAN, JUMLAH_BAHAN , NAMA_SUPPLIER) values ('$id_bahan', '$nama', '$jumlah' ,'$namasup')");
    if ($tambahbahan) {
        echo "
        <div class='alert alert-success' role='alert' style='text-align:center ;'>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li><a href="kategori.php">Supplier</a></li>
                                    <li class="active"><a href="bahan.php">Barang</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from bahan_stand order by ID_BAHAN ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $p['NAMA_BAHAN'] ?></td>
                                                    <td><?php echo $p['JUMLAH_BAHAN'] ?></td>
                                                    <td><?php echo $p['NAMA_SUPPLIER'] ?></td>
                                                    <td><?php echo $p['DATE'] ?></td>
                                                    <td>
                                                    <a ><button type="button" class="btn btn-danger">Edit</button></a>
                                                    <a href="bahan.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus data stok produk ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
